...
const HeroSection = () => {
  ...
  return (
    ...
    gap-10 max-container xl:padding-l wide:padding-r padding-b"
    >
      <div
      ...
      >
        ...
        <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82px] font-bold">
          <span className="xl:bg-white lg:whitespace-nowrap relative z-10 pr-10">
            The New Arrival
          </span>
          <br />
      ...
      <div
        ...
        max-xl:py-40 bg-primary bg-hero bg-cover bg-current"
      >
        <img
          src={bigShoeImage}
          alt="big-shoeImage"
